...
def btool(conf_file, user, app, target_dir=None):
    ...
    if target_dir:
        # Expand ~ and environment variables for shell=False compatibility
...
def get_container_btool(user, app, target_dir=None, conf_name="container_connections"):
    conf_file = conf_name
    btool_results = btool(conf_file, user, app, target_dir)
    return parse_btool_stanzas(btool_results, conf_file)

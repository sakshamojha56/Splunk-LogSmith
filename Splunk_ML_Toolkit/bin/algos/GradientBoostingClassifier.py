...
class GradientBoostingClassifier(ClassifierMixin, BaseAlgo):
    ...
    def register_codecs():
        ...
        codecs_manager.add_codec('sklearn._loss.loss', 'HalfBinomialLoss', SimpleObjectCodec)
        codecs_manager.add_codec('_loss', 'CyHalfBinomialLoss', NoopCodec)
        codecs_manager.add_codec('sklearn._loss.link', 'LogitLink', SimpleObjectCodec)
